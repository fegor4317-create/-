...
<!-- Начало сценария
var rez=[2,1,4,2,1,1,4,2,2];
var vinq=[4,3,4,4,3,4,4,2,3];
...
body {
    ...
    color: #008000;
    background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABUAAAAVCAYAAACpF6WWAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAIGNIUk0AAHolAACAgwAA+f8AAIDoAABSCAABFVgAADqXAAAXb9daH5AAAAA0SURBVHjaYvz///9/BiqC1MX/GJgYaABGDR01dNTQUUNHDR1phrKkLv5HdUMBAAAA//8DAHdWCDRrphytAAAAAElFTkSuQmCC") repeat;
	margin: 30px auto;
    width: 700px;
}
.onetest {
...
<!-- opisan -->
с помощью данного теста можно проверить теоретические зания учащихся по теме
<!-- opisan end -->
</div>
...
'<input type=radio name=Q1><span name="aspan" class="aspan" onclick="getchecked(1,0)"> Многогранник, составленный из двух п-угольников и п-треугольников.</span><br>'
+'<input type=radio name=Q1><span name="aspan" class="aspan" onclick="getchecked(1,1)"> Многогранник, составленный из двух равных п-угольников, расположенных в параллельных плоскостях,  и п параллелограммов.</span><br>'
+'<input type=radio name=Q1><span name="aspan" class="aspan" onclick="getchecked(1,2)"> Многогранник, составленный из  одного п-угольника и п-треугольников.</span><br>'
+'<input type=radio name=Q1><span name="aspan" class="aspan" onclick="getchecked(1,3)"> Многогранник, составленный из двух равных п-угольников и п-треугольников.</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
'Что представляет собой боковая грань пирамиды?'+
'</p></font><div class="otv" id="torf2"></div>'+
'<input type=radio name=Q2><span name="aspan" class="aspan" onclick="getchecked(2,0)"> Параллелограмм</span><br>'
+'<input type=radio name=Q2><span name="aspan" class="aspan" onclick="getchecked(2,1)"> Прямоугольник</span><br>'
+'<input type=radio name=Q2><span name="aspan" class="aspan" onclick="getchecked(2,2)"> Треугольник</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
'Определение правильной пирамиды.'+
'</p></font><div class="otv" id="torf3"></div>'+
'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,0)"> Прямая пирамида называется правильной, если в основании лежит правильный многоугольник.</span><br>'
+'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,1)">  Пирамида называется правильной, если в основании лежит правильный многоугольник, а отрезок, соединяющий вершину пирамиды с центром основания, является ее высотой. </span><br>'
+'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,2)"> Пирамида называется правильной, если отрезок, соединяющий вершину пирамиды с центром основания, является ее высотой.</span><br>'
+'<input type=radio name=Q3><span name="aspan" class="aspan" onclick="getchecked(3,3)"> Пирамида называется правильной, если отрезок, соединяющий вершину пирамиды с центром основания, является ее высотой.</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
'Определение апофемы.'+
'</p></font><div class="otv" id="torf4"></div>'+
'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,0)"> Высота  грани  пирамиды.</span><br>'
+'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,1)"> Высота боковой грани правильной пирамиды.</span><br>'
+'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,2)"> Высота боковой грани  пирамиды.</span><br>'
+'<input type=radio name=Q4><span name="aspan" class="aspan" onclick="getchecked(4,3)"> Высота  грани правильной пирамиды.</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
' Сколько боковых граней имеет треугольная пирамида?'+
'</p></font><div class="otv" id="torf5"></div>'+
'<input type=radio name=Q5><span name="aspan" class="aspan" onclick="getchecked(5,0)"> Одну.</span><br>'
+'<input type=radio name=Q5><span name="aspan" class="aspan" onclick="getchecked(5,1)"> Две.</span><br>'
+'<input type=radio name=Q5><span name="aspan" class="aspan" onclick="getchecked(5,2)"> Три.</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
'Что представляет собой боковая грань правильной пирамиды?'+
'</p></font><div class="otv" id="torf6"></div>'+
'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,0)"> Равносторонний треугольник</span><br>'
+'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,1)"> Квадрат</span><br>'
+'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,2)"> Прямоугольник</span><br>'
+'<input type=radio name=Q6><span name="aspan" class="aspan" onclick="getchecked(6,3)"> Равнобедренный треугольник</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
' Какая фигура не может быть в основании пирамиды?'+
'</p></font><div class="otv" id="torf7"></div>'+
'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,0)"> Трапеция</span><br>'
+'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,1)"> Круг.</span><br>'
+'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,2)"> Треугольник.</span><br>'
+'<input type=radio name=Q7><span name="aspan" class="aspan" onclick="getchecked(7,3)"> Квадрат.</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
'Сколько оснований имеет правильная пирамида?'+
'</p></font><div class="otv" id="torf8"></div>'+
'<input type=radio name=Q8><span name="aspan" class="aspan" onclick="getchecked(8,0)"> Одно.</span><br>'
+'<input type=radio name=Q8><span name="aspan" class="aspan" onclick="getchecked(8,1)"> Два.</span><br>'
,
'<font color="#333333" saze="3"><p>\r\n'+
' Площадь полной поверхности пирамиды'+
'</p></font><div class="otv" id="torf9"></div>'+
'<input type=radio name=Q9><span name="aspan" class="aspan" onclick="getchecked(9,0)"> 2Sбок.+ Sосн.</span><br>'
+'<input type=radio name=Q9><span name="aspan" class="aspan" onclick="getchecked(9,1)"> Sбок.+ Sосн.</span><br>'
+'<input type=radio name=Q9><span name="aspan" class="aspan" onclick="getchecked(9,2)"> Sбок.+ 2Sосн.</span><br>'
];
...
<a href="http://testedu.ru" style="font-size: 1px;">.</a>
</body>
</html>
